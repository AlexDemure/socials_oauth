...
from .schemas import OAuthRedirectLink, OAuthTokenResponseSchema, OAuthUserDataResponseSchema, OAuthCodeResponseSchema
...
class OAuthBase:
    ...
    def __init__(self, session: AsyncClient, client_id: str, secret_key: str, webhook_redirect_uri: str) -> None:
